...
config = {
    ...
    "hidden_dim_drug": 256,  # Example hidden dimension
    "mlp_hidden_dims_drug": [256, 128],  # Example MLP architecture
    ...
    # Key for classifier/regression head; adjust dimensions as needed.
