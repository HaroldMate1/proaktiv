...
# Define encoding methods: use Morgan for drugs and CNN for targets.
...
# Generate the configuration dictionary with parameters for Morgan (drug) and CNN (target).
...
# New code: modify dropout layers to have a dropout probability of 0.1
...
model_save_path = (
    "/home4/s6273475/ml/master_project/models/morgan_cnn/trained_model.pth"
)
...
def predict_with_uncertainty(model, data, n_iter=10):
    ...
    for _ in range(n_iter):
        ...
        # Flatten the prediction to 1D in case it is multi-dimensional.
...
if train_losses and val_losses:
    ...
    loss_plot_path = os.path.join(
        "/home4/s6273475/ml/master_project/models/morgan_cnn",
...
test_plot_path = os.path.join(
    "/home4/s6273475/ml/master_project/models/morgan_cnn", "test_inference_results.png"
)
...
# -------------------------------
output_dir = "/home4/s6273475/ml/master_project/models/morgan_cnn"
