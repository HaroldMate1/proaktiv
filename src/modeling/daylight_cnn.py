...
# Specify the encoding methods: Daylight for drugs and CNN for proteins/targets.
...
result_folder = "/home4/s6273475/ml/master_project/models/daylight_cnn"
os.makedirs(result_folder, exist_ok=True)

# Generate a configuration dictionary.
# For Daylight, CNN-specific parameters for drugs are not required.
# For the CNN target encoder, we only need CNN parameters.
config = utils.generate_config(
    drug_encoding="Daylight",  # Using Daylight (fingerprint) encoder for drugs
    target_encoding="CNN",  # Using CNN encoder for proteins/targets
    hidden_dim_drug=128,
