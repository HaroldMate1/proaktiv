...
result_folder = "/home4/s6273475/ml/master_project/models/daylight_cnn_rnn"
os.makedirs(result_folder, exist_ok=True)

# Generate a configuration dictionary.
# Note that for the Daylight encoder, CNN-specific parameters for drugs are not needed.
config = utils.generate_config(
    drug_encoding="Daylight",  # Using Daylight (fingerprint) encoder for drugs
    target_encoding="CNN_RNN",  # Using CNN_RNN encoder for proteins/targets
    hidden_dim_drug=128,
    hidden_dim_protein=256,
    # Target (CNN_RNN) parameters
