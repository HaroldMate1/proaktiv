...
# Here we specify PubChem for drugs and CNN_RNN for targets.
...
# Note: We now use PubChem for drugs and CNN_RNN for targets.
config = utils.generate_config(
    drug_encoding="Pubchem",  # Using PubChem encoder for drugs
    target_encoding="CNN_RNN",  # Using CNN_RNN encoder for targets
    hidden_dim_drug=128,
    hidden_dim_protein=256,
    # CNN_RNN target parameters:
    cnn_target_filters=[128, 256],
    cnn_target_kernels=[8, 8],
