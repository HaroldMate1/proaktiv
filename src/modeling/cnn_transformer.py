...
# Define encoding methods: use CNN for drugs and Transformer for proteins.
...
# Generate the configuration dictionary without transformer-specific parameters.
config = utils.generate_config(
    ...
    LR=0.001,
    batch_size=128,
    # CNN parameters for drug encoder
...
# Enable GPU usage in the config dictionary.
