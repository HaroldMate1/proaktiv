...
# Here we specify the encoding methods for drugs and proteins.
...
result_folder = "/home4/s6273475/ml/master_project/models/cnn_cnn_rnn_in_progress"
os.makedirs(result_folder, exist_ok=True)

# Generate a configuration dictionary.
# Note: Even though DeepPurpose has default configurations, model_initialize expects
# keys such as 'drug_encoding' and 'target_encoding'. Here we use generate_config to ensure that.
config = utils.generate_config(
    drug_encoding="CNN",
    target_encoding="CNN_RNN",
    hidden_dim_drug=128,
    cnn_drug_filters=[64, 128, 256],
    cnn_drug_kernels=[3, 5, 7],
